...
class TestUserService:
    ...
    async def test_create_user_duplicate_email(
        self, test_db_session, created_user, sample_user_data
    ):
    ...
    async def test_authenticate_user_success(
        self, test_db_session, created_user, sample_login_data
    ):
        """사용자 인증 성공 테스트"""
        # Given
        user_service = UserService(test_db_session)
    ...
    async def test_update_user_success(
        self, test_db_session, created_user, sample_user_update_data
    ):
        """사용자 정보 수정 성공 테스트"""
        # Given
        user_service = UserService(test_db_session)
    ...
    async def test_logout_user_success(self, test_db_session, created_user):
        ...
        with patch(
            ...
            "app.utils.auth.AuthUtils.verify_token", return_value={"exp": 9999999999}
        ):
