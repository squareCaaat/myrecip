...
from app.models.schemas import Token, UserCreate, UserLogin, UserResponse, UserUpdate
...
class UserService:
    ...
    async def authenticate_user(self, login_data: UserLogin) -> Token:
        ...
        await redis_client.set_token(
            str(user.user_id), access_token, settings.access_token_expire_minutes * 60
        )
