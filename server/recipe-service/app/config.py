...
class Settings(BaseSettings):
    ...
    # 데이터베이스 설정
    database_url: str = Field(default="postgresql://postgres:password@localhost:5432/test_db", alias="DATABASE_URL")
    ...
    allowed_extensions: List[str] = Field(default=["jpg","jpeg","png","gif"], alias="ALLOWED_EXTENSIONS")
