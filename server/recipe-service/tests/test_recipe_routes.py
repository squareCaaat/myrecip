...
class TestRecipeRoutes:
    ...
    def test_get_my_recipes_pagination(self, test_client, auth_headers):
        """내 레시피 목록 페이징 테스트"""
        # When
        response = test_client.get("/api/recipes/?page=1&per_page=5", headers=auth_headers)
    ...
    def test_create_recipe_success(self, test_client, auth_headers, sample_recipe_data):
        ...
        # When
        response = test_client.post("/api/recipes/", json=recipe_data, headers=auth_headers)
    ...
    def test_create_recipe_missing_fields(self, test_client, auth_headers):
        ...
        # When
        response = test_client.post("/api/recipes/", json=incomplete_data, headers=auth_headers)
    ...
    def test_get_recipe_not_found(self, test_client, auth_headers):
        ...
        # When
        response = test_client.get(f"/api/recipes/{non_existent_id}", headers=auth_headers)
    ...
    def test_update_recipe_success(self, test_client, auth_headers, created_recipe, sample_recipe_update_data):
        """레시피 수정 성공 테스트"""
        # Given
        recipe_id = str(created_recipe.recipe_id)
        ...
        # When
        response = test_client.put(f"/api/recipes/{recipe_id}", json=update_data, headers=auth_headers)
    ...
    def test_update_recipe_partial(self, test_client, auth_headers, created_recipe):
        ...
        # When
        response = test_client.put(f"/api/recipes/{recipe_id}", json=partial_update, headers=auth_headers)
    ...
    def test_delete_recipe_not_found(self, test_client, auth_headers):
        ...
        # When
        response = test_client.delete(f"/api/recipes/{non_existent_id}", headers=auth_headers)
    ...
    def test_create_share_link_success(self, test_client, auth_headers, created_recipe):
        ...
        # When
        response = test_client.post(f"/api/recipes/{recipe_id}/share", headers=auth_headers)
    ...
    def test_create_share_link_not_found(self, test_client, auth_headers):
        ...
        # When
        response = test_client.post(f"/api/recipes/{non_existent_id}/share", headers=auth_headers)
    ...
    def test_get_shared_recipe_success(self, test_client, created_recipe, auth_headers):
        ...
        # 먼저 공유 링크 생성
        share_response = test_client.post(f"/api/recipes/{recipe_id}/share", headers=auth_headers)
...
class TestImageRoutes:
    ...
    def test_upload_recipe_image_success(self, mock_exists, mock_aiofiles_open, mock_remove, test_client, auth_headers, created_recipe):
        """레시피 이미지 업로드 성공 테스트"""
        # Given
        recipe_id = str(created_recipe.recipe_id)
    ...
    def test_upload_recipe_image_not_found(self, test_client, auth_headers):
        ...
        # When
        response = test_client.post(
            f"/api/recipes/{non_existent_id}/image", 
            files=files, 
            headers=auth_headers
        )
    ...
    def test_get_visual_image_success(self, mock_visualization, test_client, created_recipe):
        """시각화 이미지 생성 성공 테스트"""
        # Given
        recipe_id = str(created_recipe.recipe_id)
